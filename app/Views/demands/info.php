                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Demand Details</h4>
                            </div>
                            <div class="card-body">
                            <div class="ml-auto">
                                <a href="<?php echo base_url(); ?>/uploadingdemandcsv" class="btn btn-primary me-md-2">Upload CSV Demand File</a>
                             <!--   <a href="<?php echo base_url(); ?>/addnewdemands" class="btn btn-primary me-md-2">Add New Single Demand</a> -->
                            </div>
                            <br>
