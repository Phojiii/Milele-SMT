...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Registor New User | MILELE</title>
    ...
    <!-- <body data-layout="horizontal"> -->
        <div class="auth-page">
            <div class="container-fluid p-0">
                ...
                <?php endif;?>
                                            <p class="text-muted mt-2">Registor New User On Milele.</p>
                                        </div>
                                        <form class="custom-form mt-4 pt-2" action="<?php echo base_url(); ?>/registers"method="post">
                                            <div class="mb-3">
											...
											<div class="mb-3">
                                                <label for="choices-single-default" class="form-label font-size-13 text-muted">Department</label>
                                                <select class="form-control" id="choices-single-default" placeholder="This is a search placeholder" name="department">
                                                    <option value="Fin">Fin</option>
                                                    <option value="warehouse">Warehouse</option>
                                                    <option value="sales">Sales</option>
													<option value="Purcahser">Purcahser</option>
                                                    <option value="Logistics">Logistics</option>
                                                    <option value="QC Team">QC / QA Team</option>
                                                </select>
                                            </div>
											<div class="mb-3">
                                               <label for="choices-single-default" class="form-label font-size-13 text-muted">Permission</label>
                                                <select class="form-control" id="choices-single-default" placeholder="This is a search placeholder" name="permission">
                                                    <option value="1">Full Edit</option>
                                                    <option value="2">Department Edit</option>
                                                    <option value="3">View Only</option>
                                                </select>
                                            </div>
                                            <div class="mb-3">
                                                <button class="btn btn-primary w-100 waves-effect waves-light" type="post">Registered</button>
                                            </div>
                                        </form>
                                    </div>
